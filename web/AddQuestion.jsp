<%-- 
    ...
    Created on : Oct 31, 2024, 6:48:14 AM
    Author     : Windows 10
--%>
        ...
        <div class="container">
            ...
            <form action="${pageContext.request.contextPath}/adm" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea id="content" name="content" rows="4" required>${param.content}</textarea>
                </div>

                <div class="form-group">
                    <label for="correctAnswer">Correct Answer:</label>
                    <input type="text" id="correctAnswer" name="correctAnswer" value="${param.correctAnswer}" required>
                </div>
